...
# BALANCE RUNS LAST, AND DOES NOT BLOCK WHAT FOLLOWS IT. (Ported from mirage-0.13.1.)
#
...
if [ "$BALANCE" -ne 0 ]; then
  echo "ALL SEVEN TESTS PASSED — except balance, the known open difficulty question"
  exit 1
fi
