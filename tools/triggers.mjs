...
// while building THE WOODS was already recorded somewhere; none of them
// surfaced, because the search key was the answer rather than the situation.
//
...
// of Brain that will drift from the first (mirage#E17 is precisely that
// failure: one value, two homes, only one of them updated).
//
// Usage:
...
export const TRIGGERS = [
  {
    ...
    from: "seven: a default lives twice (FOV 90->78 left the pause ladder and main.js behind)",
  },
  {
  ...
  },
  {
    ...
    from: "seven: one WebGL context per mount",
  },
  {
    ...
    from: "seven: a sentinel that nothing routes",
  },
  {
    ...
    from: "seven: one account, one origin",
  },
  {
  ...
  },
  {
    ...
    from: "seven: a source window with an expiry date",
  },
  {
    ...
    from: "seven: a callback that draws",
  },
  {
    ...
    from: "seven: the frame timestamp is not the clock",
  },
  {
    ...
    from: "seven: a known-red test in the middle",
  },
  {
    ...
    from: "seven: a verifier pinned to its own name",
  },
  {
    ...
    from: "seven: session 2026-08-30, the largest single waste",
  },
];
