...
import { perceivedMonoliths, perceivedPylons, perceivedCompanions, perceivedWorldItems, distortion } from "./percept.js?v=seven-0.16.0";
import { PYLON_RADIUS } from "./state.js?v=seven-0.16.0";
