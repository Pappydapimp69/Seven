...
import { HALLUCINATION, BAND, bandOf, ITEM_INFO, LUCIDITY_GRACE, CORROBORATE_RADIUS } from "./state.js?v=mirage-0.11.1";
import { ITEM_KINDS } from "./world.js?v=mirage-0.11.1";
