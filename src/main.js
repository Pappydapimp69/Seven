...
} from "./state.js?v=mirage-0.12.1";
import { STAGES, openObjective, checkTrainer, observe, objectiveText, stageById } from "./tutorial.js?v=mirage-0.12.1";
import { buildCamp, CAMP_SEED } from "./camp.js?v=mirage-0.12.1";
import { createPercept, updatePercept, distortion, perceivedMonoliths, believedKinds } from "./percept.js?v=mirage-0.12.1";
import { createRenderer } from "./render.js?v=mirage-0.12.1";
import { createHud, renderDebrief, paintHint } from "./hud.js?v=mirage-0.12.1";
import { createInput, ACTIONS } from "./input.js?v=mirage-0.12.1";
import { createAudio } from "./audio.js?v=mirage-0.12.1";
import { hashSeed } from "./rng.js?v=mirage-0.12.1";
import { saveRun, loadSave, clearSave, deserializeRun, describeSave, loadSettings, saveSettings } from "./save.js?v=mirage-0.12.1";

const BUILD = "mirage-0.12.1";
