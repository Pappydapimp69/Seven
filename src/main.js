...
import { STAGES, openObjective, checkTrainer, observe, objectiveText, stageById } from "./tutorial.js?v=mirage-0.11.2";
import { buildCamp, CAMP_SEED } from "./camp.js?v=mirage-0.11.2";
