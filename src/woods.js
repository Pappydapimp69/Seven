...
import { makeChronicle, record, fact, account, pickPerturbation, WEATHERS } from "./chronicle.js?v=seven-0.14.0";
import { makeRoster, nearMiss } from "./names.js?v=seven-0.14.0";
